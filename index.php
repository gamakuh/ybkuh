...
if (isset($_GET['daftar'])) {
    $brandFileName = "brandlist.txt";
    $titleFileName = "title.txt";
    $contentFileName = "description.txt";

    $brandList = file($brandFileName, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
    $titleList = file($titleFileName, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
    $contentList = file($contentFileName, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
    $targetString = strtolower($_GET['daftar']);

    $key = array_search($targetString, $brandList);

    if ($key !== false) {
        $titleIndex = $key % count($titleList);
        $contentIndex = $key % count($contentList);

        $title = $titleList[$titleIndex] ?? '';
        $content = $contentList[$contentIndex] ?? '';

        $BRAND = strtoupper($targetString);
    }
//    } else {
//        echo "Brand not found.\n";
//    }
    if (isset($BRAND)) {
        $BRANDS = str_replace('_', ' ',  $BRAND);
...
*GANTI NAMA TITLE DENGAN INI
<?php echo $title ?>

*GANTI NAMA DESC DENGAN INI
<?php echo $content ?>
...
<head>
    ...
    <style>
        ...
        .lzd-header-banner {
            background-image: url(https://i.ibb.co/9Th9k06/image.png) !important;
    ...
    <script type="application/ld+json">
      {
        ...
        "offers": {
          ...
          "hasMerchantReturnPolicy": {
            ...
            "merchantReturnLink": "<?php echo $urlPath ?>",
        ...
        "review": {
          ...
          "reviewBody": "Product di Login Situs Slot Gacor"
        }
      }
    </script>
                        ...
                        <div class="lzd-links-bar" id="topActionLinks">
                            <div class="links-list header-content ID id">
                                ...
                                <div class="top-links-item" id="topActionFeedback">
                                    <a class="highlight" target="_blank" href="<?php echo $urlPath ?>"
                                        data-spm-click="gostr=/lzdpub.header.tbar;locaid=dfeedback">SLOT88</a>
                                </div>
                                                        ...
                                                        <div class="promotion-text">
                                                            <a
                                                                ...
                                                                <div class="get-the-app-download-text">
                                                                    <p>
                                                                        Daftar Situs SLOT GACOR pasti bayar:
                                                                    </p>
                                                                    <ul>
                                                                        <li>Banyak Bonusnya</li>
                                                                        <li>Produk Eksklusif di App</li>
                                                                        <li>
                                                                            Rekomendasi Situs Slot Gacor Terbaik
                                                                        </li>
                                ...
                                <div class="top-links-item" id="topActionSell">
                                    <a class="cyan" href="<?php echo $urlPath ?>"
                        ...
                        <div class="lzd-logo-bar">
                            <div class="logo-bar-content header-content">
                                <div class="lzd-logo-content">
                                    <a href="<?php echo $urlPath ?>" data-spm="dhome"><img
                                            src="https://i.ibb.co/TM5XtBm/image.png"
                                            alt="logo slot gacor" /></a>
                                </div>
                                                    ...
                                                    <a class="lzd-menu-labels-item"
                                                        ...
                                                        <span
                                                            ...
                                                            <img alt="SLOT GACOR" class="lzd-site-nav-menu-iconfont-img"
                                                                src="https://i.ibb.co/9Th9k06/image.png" />
                                                        </span>
                    ...
                    <div id="block-6QhDn4z1db" class="pdp-block">
                        <div id="block-ssuYrXSucaM" class="pdp-block pdp-block__product-detail">
                                    ...
                                    <div id="module_product_review_star_1" class="pdp-block module">
                                        <div class="pdp-review-summary">
                                            <div class="container-star pdp-review-summary__stars pdp-stars_size_s">
                                                <img class="star"
                                                    src="https://i.ibb.co/m9QQTpj/image.png" /><img
                                                    class="star"
                                                    src="https://i.ibb.co/m9QQTpj/image.png" />
                                                <img class="star"
                                                    src="https://i.ibb.co/m9QQTpj/image.png" /><img
                                                    class="star"
                                                    src="https://i.ibb.co/m9QQTpj/image.png" />
                                            ...
                                            <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-review-summary__link"
                                                data-spm-anchor-id="12anj4u.pdp_revamp.0.0">777.77.777 Penilaian</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="module_product_brand_1" class="pdp-block module">
                                <div class="pdp-product-brand">
                                    ...
                                    <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link"
                                        target="_self" href="<?php echo $urlPath ?>">Slot Online Terpercaya</a>
                            ...
                            <div class="content">
                                ...
                                <p><?php echo $BRANDS ?> adalah situs <span><a title="Slot Gacor" href="<?php echo $urlPath ?>" style="color: #ffcc00;"><strong>Slot Gacor</strong></a></span> online resmi yang menjadi pilihan utama bagi para penggemar slot online di Indonesia. Dengan fokus pada permainan slot gacor yang gampang menang, <?php echo $BRANDS ?> menghadirkan pengalaman bermain yang seru, aman, dan tentunya menguntungkan. Sebagai situs terpercaya, <?php echo $BRANDS ?> menyediakan link slot777 resmi yang memudahkan pemain untuk mengakses berbagai permainan slot terbaru dengan tingkat kemenangan tinggi.</p>
                                <p>Sebagai situs <span><a title="slot gacor hari ini" href="<?php echo $urlPath ?>" style="color: #ffcc00;"><strong>slot gacor hari ini</strong></a></span>, <?php echo $BRANDS ?> dikenal karena menghadirkan permainan dengan RTP (Return to Player) tinggi dan winrate yang menguntungkan. Hal ini membuat para pemain memiliki peluang besar untuk mendapatkan jackpot atau maxwin setiap harinya. Dengan koleksi permainan slot terbaru 2024 dari provider-provider ternama seperti Pragmatic Play, Habanero, PG Soft, dan lainnya, <?php echo $BRANDS ?> memastikan bahwa setiap pemain dapat menikmati permainan slot yang gacor dan penuh keseruan.
                                </p>
                                <p>Salah satu keunggulan <?php echo $BRANDS ?> adalah kemampuannya untuk menghadirkan permainan slot gacor terbaru yang selalu diperbarui. Dengan fitur <span><a title="slot" href="<?php echo $urlPath ?>" style="color: #ffcc00;"><strong>slot</strong></a></span> gacor hari ini, pemain dapat menemukan permainan yang sedang "panas" dan memiliki peluang menang lebih tinggi. Selain itu, <?php echo $BRANDS ?> juga memberikan berbagai promo menarik seperti bonus deposit, cashback, dan free spin yang semakin menambah keseruan bermain.
                                </p>
                                <p>Bagi Anda yang mencari <span><a title="situs slot gacor" href="<?php echo $urlPath ?>" style="color: #ffcc00;"><strong>situs slot gacor</strong></a></span> terpercaya dengan peluang menang besar, <?php echo $BRANDS ?> adalah pilihan yang tepat. Dengan berbagai keunggulan yang ditawarkan, mulai dari permainan slot gacor terbaru hingga pelayanan terbaik, <?php echo $BRANDS ?> menjadi platform yang wajib dicoba oleh para penggemar slot online. Bergabunglah sekarang dan rasakan sendiri sensasi bermain di situs slot gacor terbaik 2024!
                                </p>
                                    ...
                                    <div class="seller-container" data-spm="seller">
                                        <div class="seller-name">
                                            <div class="seller-name__wrapper">
                                                <div class="seller-name__title">&copy; 2024 <?php echo $BRANDS ?> All Rights Reserved</div>
                            ...
                            ">
                                            ...
                                            <div class="lzd-footer-width-25">
                                                <div class="lzd-footer-copyright">© SLOT777 2024</div>
                                            </div>
                                        </div>
                                    </div>
                                </section>
